function frame_transform = create_mobile_frame()
    ...
    text(axis_length + text_offset, 0, 0, 'X', 'Color', 'r', 'FontWeight', 'bold', 'Parent', frame_transform);

    line([0 0], [0 axis_length], [0 0], 'Color', 'g', 'LineWidth', 2, 'Parent', frame_transform);
    text(0, axis_length + text_offset, 0, 'Y', 'Color', 'g', 'FontWeight', 'bold', 'Parent', frame_transform);

    line([0 0], [0 0], [0 axis_length], 'Color', 'b', 'LineWidth', 2, 'Parent', frame_transform);
    text(0, 0, axis_length + text_offset, 'Z', 'Color', 'b', 'FontWeight', 'bold', 'Parent', frame_transform);
end